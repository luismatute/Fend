...
;(function (window, undefined){
	...
	var _util = {
		...
		// Print Form values
			dump_form: function($form) {
				console.group("%c Form data sent to backend:", "color: #2c3e50");
				$.each($form.serializeArray(),function(){
					console.log("%c " + $(this)[0].name + "%c = " + "%c" + $(this)[0].value, 'color: #c0392b', 'color: #2c3e50', 'color: #27ae60');
				});
				console.groupEnd();
			},
